package tk.cucurbit.oauth2.config.tokenstore;
...
import tk.cucurbit.oauth2.config.serialize.OAuth2AccessTokenJacksonDeserializer;
import tk.cucurbit.oauth2.config.serialize.OAuth2AccessTokenJacksonSerializer;
import tk.cucurbit.oauth2.config.serialize.OAuth2AuthenticationJackson2Deserializer;
...
/**
 * custom object mapper. registerModule~   CoreJackson2Module, WebJackson2Module.
...
//    @JsonTypeInfo(use = JsonTypeInfo.Id.CLASS, property = "@class")
    ...
    private OAuth2AccessToken deserializeAccessToken(byte[] bytes) {
        ...
        try {
            return objectMapper.readValue(bytes, OAuth2AccessToken.class);
        } catch (IOException e) {
    ...
    private OAuth2Authentication deserializeAuthentication(byte[] bytes) {
        ...
        try {
            return objectMapper.readValue(bytes, OAuth2Authentication.class);
        } catch (IOException e) {
            throw new SerializationException("Cannot deserialize", e);
        }
    }
    ...
    private OAuth2RefreshToken deserializeRefreshToken(byte[] bytes)  {
        ...
        try {
            return objectMapper.readValue(bytes, OAuth2RefreshToken.class);
        } catch (IOException e) {
            throw new SerializationException("Cannot deserialize", e);
        }
    }
